...
const translations = {
    en: {
        ...
        productsCat4Prod1Desc: "We help you choose and implement the best models on the market (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) for your specific needs.",
    ...
    es: {
        ...
        productsCat4Prod1Desc: "Te ayudamos a elegir e implementar los mejores modelos del mercado (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) para tus necesidades específicas.",
    ...
    de: {
        ...
        productsCat4Prod1Desc: "Wir helfen Ihnen bei der Auswahl und Implementierung der besten Modelle auf dem Markt (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) für Ihre spezifischen Bedürfnisse.",
    ...
    fr: {
        ...
        productsCat4Prod1Desc: "Nous vous aidons à choisir et à mettre en œuvre les meilleurs modèles du marché (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) pour vos besoins spécifiques.",
    ...
    pt: {
        ...
        productsCat4Prod1Desc: "Ajudamos você a escolher e implementar os melhores modelos do mercado (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) para suas necessidades específicas.",
    ...
    ca: {
        ...
        productsCat4Prod1Desc: "T'ajudem a triar i implementar els millors models del mercat (OpneAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) per a les teves necessitats específiques.",
