...
const translations = {
    en: {
        ...
        productsCat4Prod1Desc: "We help you choose and implement the best models on the market (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) for your specific needs.",
    ...
    es: {
        ...
        productsCat4Prod1Desc: "Te ayudamos a elegir e implementar los mejores modelos del mercado (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) para tus necesidades específicas.",
    ...
    de: {
        ...
        productsCat4Prod1Desc: "Wir helfen Ihnen bei der Auswahl und Implementierung der besten Modelle auf dem Markt (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) für Ihre spezifischen Bedürfnisse.",
    ...
    fr: {
        ...
        productsCat4Prod1Desc: "Nous vous aidons à choisir et à mettre en œuvre les meilleurs modèles du marché (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) pour vos besoins spécifiques.",
    ...
    zh: {
        ...
        productsCat4Prod1Desc: "我们帮助您根据您的特定需求，选择和实施市场上最好的模型（OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral）。",
    ...
    pt: {
        ...
        productsCat4Prod1Desc: "Ajudamos você a escolher e implementar os melhores modelos do mercado (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) para suas necessidades específicas.",
    ...
    ca: {
        ...
        productsCat4Prod1Desc: "T'ajudem a triar i implementar els millors models del mercat (OpenAi GPT, Google Gemini, Anthropic, Llama, Claude, Mistral) per a les teves necessitats específiques.",
